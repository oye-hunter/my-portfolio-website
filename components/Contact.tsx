...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative z-10 mx-auto max-w-7xl px-6 py-24 md:px-8 lg:px-12 scroll-mt-24">
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <div data-reveal className="reveal">
          ...
          <div className="flex flex-col gap-3">
            <a
              className="flex items-center gap-3 border border-transparent px-4 py-3 font-[var(--font-mono)] text-[0.85rem] tracking-[0.08em] text-[#b07800] transition-colors duration-200 hover:border-[#3a2a00] hover:text-[#ffb000] cursor-none"
        ...
        <form data-reveal className="reveal flex flex-col gap-5" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              className="border border-[#3a2a00] bg-[#0f0c00] px-4 py-3 font-[var(--font-body)] text-[0.95rem] text-[#ffb000] outline-none transition-colors duration-200 placeholder:text-[#b07800] focus:border-[#b07800] focus:shadow-[0_0_12px_rgba(255,176,0,0.1)] cursor-none"
            />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              required
              className="min-h-[130px] border border-[#3a2a00] bg-[#0f0c00] px-4 py-3 font-[var(--font-body)] text-[0.95rem] text-[#ffb000] outline-none transition-colors duration-200 placeholder:text-[#b07800] focus:border-[#b07800] focus:shadow-[0_0_12px_rgba(255,176,0,0.1)] cursor-none"
            />
          </div>

          <button
            className="btn-crt-shimmer mt-2 inline-flex w-fit items-center justify-center border border-[#ffb000] px-8 py-3 font-[var(--font-mono)] text-[0.85rem] uppercase tracking-[0.15em] text-[#ffb000] transition-all duration-200 hover:bg-[#ffb000] hover:text-[#0a0800] hover:shadow-[0_0_20px_rgba(255,208,64,0.5)] active:scale-[0.97] cursor-none"
            type="submit"
          >
            Send Message
          </button>
