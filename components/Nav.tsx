        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <div className="flex items-center gap-2">
            {onReboot && (
              <button
                onClick={onReboot}
                className="hidden md:inline-flex items-center border border-[#b07800] px-2.5 py-1 font-[var(--font-mono)] text-[0.7rem] uppercase tracking-widest text-[#b07800] transition-colors duration-200 hover:border-[#ffb000] hover:text-[#ffb000]"
            ...
            {onOpenTerminal && (
              <button
                ...
                className="hidden sm:inline-flex items-center border border-[#39ff14] px-3 py-1 font-[var(--font-mono)] text-[0.72rem] uppercase tracking-widest text-[#39ff14] transition-colors duration-200 hover:bg-[#39ff14] hover:text-[#0a0800] shadow-[0_0_10px_rgba(57,255,20,0.2)]"
              >
                [ &gt;_ CLI ]
              </button>
            )}
